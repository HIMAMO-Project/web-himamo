                ...
                <div class="container cont-2 px-5">
                    <div class="row">
                        <div class="col-md-12 text-center gs_reveal">
                            <h3 class="text-dark quote">Program Studi <span class="judul">Jurusan Teknik Otomasi Manufaktur
                                    dan Mekatronika</span></h3>
                        </div>
                    </div>
                    ...
                    <div class="pt-3 col-md-10">
                        <div class="owl-carousel owl-one owl-theme">
                            ...
                            <div class="block block-10">
                                <h1 class="text-light">Ekonomi Kre<span class="judul d-none d-lg-inline">atif.</span><span
                                        class="d-inline d-lg-none">atif.</span></h1>
                            </div>
                            ...
                            <div class="block block-14">
                                <h1 class="text-light">Kajian Strate<span
                                        class="judul d-none d-lg-inline">gis.</span><span
                                        class="d-inline d-lg-none">gis.</span></h1>
                            </div>
                            ...
                            <div class="block block-17">
                                <h1 class="text-light">Me<span class="judul d-none d-lg-inline">dia.</span><span
                                        class="d-inline d-lg-none">dia.</span></h1>
                            </div>
                            <div class="block block-18">
                                <h1 class="text-light">Inform<span class="judul d-none d-lg-inline">asi.</span><span
                                        class="d-inline d-lg-none">asi.</span></h1>
                            </div>
                            ...
                            <div class="block block-22">
                                <h1 class="text-light">Relasi Organis<span
                                        class="judul d-none d-lg-inline">asi.</span><span
                                        class="d-inline d-lg-none">asi.</span></h1>
                            </div>
                            <div class="block block-23">
                                <h1 class="text-light">Sarana Prasara<span
                                        class="judul d-none d-lg-inline">na.</span><span
                                        class="d-inline d-lg-none">na.</span></h1>
                            </div>
                            ...
                            <div class="block block-26">
                                <h1 class="text-light">Ta<span class="judul d-none d-lg-inline">tib.</span><span
                                        class="d-inline d-lg-none">tib.</span></h1>
                            </div>
                            <div class="block block-27">
                                <h1 class="text-light">Timeli<span class="judul d-none d-lg-inline">ner.</span><span
                                        class="d-inline d-lg-none">ner.</span></h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container pb-3">
                    ...
                    <div class="container cont-2 px-5 pb-2">
                        ...
                        <div class="row pt-1 pb-4 subject-list gs_reveal">
                            ...
                            <div class="col-12 col-md-6 mt-4 col-lg text-center">
                                <div class="subject-box">
                                    <img src="{{ asset('assets-guest/img/teori_subject.svg') }}" alt="Robotika"
                                        class="subject-image">
                                    ...
                                    <div class="testimony-wrap py-4">
                                        <div class="text">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="user-img"
                                                    style="background-image: url('{{ asset('assets-guest/img/img-avatar-pria.jpg') }}');">
                                                </div>
                                                <div class="ps-3">
                                ...
                                <div class="item">
                                    <div class="testimony-wrap py-4">
                                        ...
                                        <div class="text">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="user-img"
                                                    style="background-image: url('{{ asset('assets-guest/img/img-avatar-wanita.jpg') }}');">
